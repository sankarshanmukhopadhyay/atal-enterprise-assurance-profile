...
def main() -> int:
    ...
    claim = {
        ...
        "profile": {"id": "EAP-L2", "version": repository_version()},
        "state": state,
        "control_summary": counts,
        "evidence_bundle": {"path": "examples/eap-l2-worked-example/evidence-bundle.json", "sha256": digest(CASE / "evidence-bundle.json")},
        "assessment": {"path": "examples/eap-l2-worked-example/assessment-result.json", "sha256": digest(CASE / "assessment-result.json")},
        "validity": {"assessed_at": "2026-08-22T15:10:00Z", "expires_at": "2026-11-20T23:59:59Z", "revoked_at": None, "revocation_reason": None},
        "authorities": {
    ...
    print(f"✓ wrote {OUT.relative_to(ROOT)} for v{repository_version()}")
    return 0
